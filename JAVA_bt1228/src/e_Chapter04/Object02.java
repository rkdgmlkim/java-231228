...
//- 클래스를 기반으로 생성, 클래스의 instance라고 불림
//- 긱 겍체는 독립적인 상태와 행동을 가짐, 다른 객체와 상호작용 가능
...
//className
//클래스명
//: 명명규칙 - 명사, 대문자로 시작, 파스칼 케이스(첫 번째 글자는 대문자, 연결 키워드 시작 대문자)
...
public class Object02 {
	...
	public static void main(String[] args) {
		...
		class Car {
			...
			int maxSpeed; //최대 속력
			double weight; //중량
			boolean isElactric; //전기자동차인지에 대한 여부
		}
		
		class Book {
			String title; //책 제목
			String author; //저자
			int[] pagaNumber; //책의 페이지 수
		}
