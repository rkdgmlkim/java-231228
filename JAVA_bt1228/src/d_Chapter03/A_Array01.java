...
public class A_Array01 {
	...
	public static void main(String[] args) {
		...
		// : 배열의 길이는 고정, 한 번 생성된 배열의 크기는 변경 X
		int[] myArray = {1, 4, 2, 6, 4, 5, 2, 6, 7, 4, 7, 8, 5};
		// 배열명.length
		...
		//배열의 첫 번째 요소부터 마지막 요소까지의 수만큼 반복
