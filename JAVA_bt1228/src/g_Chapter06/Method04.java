...
//정적 메소드
//: 메소드 앞에 static 키워드를 붙이는 경우 클래스(정적) 메서드 생성 가능
//: 객체를 셍성하지 않고도 '클래스명.메소드명(매개변수)'으로 호출 가능

//: 인스턴스 변수와 관계없는 메소드를 클래스 메소드로 정의
...
class Operator {
	...
	//정적 메소드: 인스턴스 변수와 관계없이 매개변수만으로 작업 가능
